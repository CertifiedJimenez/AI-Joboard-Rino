...
export const get_jobs_skills_match = async (name: string, location: string): Promise<JobData[]> => {
  ...
  return fetch(`${PORT_URL}/get_jobs_skills_match/${name}/${location}`, requestOptions)
